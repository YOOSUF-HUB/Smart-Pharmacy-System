...
class MedicineForm(forms.ModelForm):
    med_code = forms.CharField(max_length=10, required=True, label="Medicine Code", widget=forms.TextInput(attrs={'placeholder': 'MEDCODE', 'class': 'form-control'}))
    batch_date = forms.CharField(max_length=8, required=True, label="Batch Date", widget=forms.TextInput(attrs={'placeholder': 'YYYYMMDD', 'class': 'form-control'}))
